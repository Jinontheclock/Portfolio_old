...
export default function ProjectIceland({ currentPage, language, onNavigate, onLanguageChange }: Props) {
    ...
    return (<div className="layout-viewport hide-scrollbar bg-grey-normal" style={{ "--layout-gutter": "0px" } as CSSProperties}>
      <div className="layout-canvas" style={{ "--layout-base-height": `${PROJECT_LAYOUT_METRICS.iceland.baseHeight}px` } as CSSProperties}>
        <div className="layout-canvas-inner">
          <div className="relative" style={{ minHeight: "var(--layout-base-height)" } as CSSProperties}>
            ...
            <div className="flex flex-col gap-0 mt-12">
              <ProjectHeader {...PROJECT_HEADER_CONTENT.iceland}/>

              <section className="px-6" data-lightbox-disabled="true">
                <div className="flex justify-center">
                  <img src={IcelandHero} alt="Best of Iceland overview" className="w-full max-w-[1400px] h-auto"/>
                </div>
              </section>
            </div>
            ...
            ['Caption', '8px BookOblique Avenir', { fontFamily: 'Avenir, Helvetica, Arial, sans-serif', fontSize: 8, fontWeight: 400, fontStyle: 'italic', lineHeight: 1.3 }],
        ].map(([label, value, style]) => (<div key={label as string} className="grid grid-cols-[140px_1fr] items-start gap-6">
                            <div>
                  ...
                  <div className="project-right-block">
                    ...
                    <div className="flex flex-wrap gap-4 justify-start">
                      {[Map1, Map2, Map3].map((src, idx) => (<figure key={src} className="p-0 m-0 text-left w-[32%]">
            ...
            <section className="px-6 pb-16 mt-12">
              <ProjectTwoColumnSection left={<h2 className="type-heading-2 text-black-normal m-0 leading-[1.2] whitespace-nowrap">02 Digital Edition</h2>} rightClassName="project-right-column pl-48 max-w-[1280px]">
                  <div className="project-right-block">
                    <div className="rounded-[4px] shadow-sm overflow-hidden bg-white" style={{ height: 640, minHeight: 400 }}>
                        <iframe title="Best of Iceland publication" src={PROJECT_EMBED_URLS.iceland.digitalEdition} width="100%" height="100%" style={{ border: 'none' }} allowFullScreen/>
                    </div>
                  </div>
              </ProjectTwoColumnSection>
            </section>
            ...
            <Footer onNavigate={onNavigate} top={PROJECT_LAYOUT_METRICS.iceland.footerTop}/>
