...
export default function ProjectTinyPaws({ currentPage, language, onNavigate, onLanguageChange }: Props) {
    ...
    return (<div className="layout-viewport hide-scrollbar bg-grey-normal" style={{ "--layout-gutter": "0px" } as CSSProperties}>
      <div className="layout-canvas" style={{ "--layout-base-height": `${PROJECT_LAYOUT_METRICS.tinypaws.baseHeight}px` } as CSSProperties}>
          ...
          <div className="relative" style={{ minHeight: "var(--layout-base-height)" } as CSSProperties}>
            ...
            <div className="tinypaws-page-enter-content" onClickCapture={handleProjectImageClickCapture}>
              ...
              <div className="flex flex-col gap-0 mt-12">
                <ProjectHeader {...PROJECT_HEADER_CONTENT.tinypaws}/>

                <section className="px-6" data-lightbox-disabled="true">
                  <div className="flex justify-center">
                    <img src={TinyBanner} alt="TinyPaws overview" className="w-full max-w-[1400px] h-auto"/>
                  </div>
                </section>
              </div>
              ...
              <div>
                ...
                <section className="px-6 pb-16 mt-16">
                  <ProjectTwoColumnSection left={<h2 className="type-heading-2 text-black-normal m-0 leading-[1.2] whitespace-nowrap">01 Why TinyPaws was created</h2>} rightClassName="grid gap-6 pl-48 max-w-[1280px]">
                ...
                <section className="px-6 pb-16 mt-12">
                  <ProjectTwoColumnSection left={<h2 className="type-heading-2 text-black-normal m-0 leading-[1.2] whitespace-nowrap">02 Research & Analysis</h2>} rightClassName="project-right-column pl-48 max-w-[1280px]">
                    ...
                    <div className="project-right-block">
                      ...
                      <div className="grid grid-cols-2 gap-6">
                        <img src={Persona1} alt="User persona Emily Green" className="w-full h-auto object-contain"/>
                        <img src={Persona2} alt="User persona Alex Kim" className="w-full h-auto object-contain"/>
                      </div>
                    </div>
                  </ProjectTwoColumnSection>
              </section>
              ...
              <section className="px-6 pb-16 mt-12">
                <ProjectTwoColumnSection left={<h2 className="type-heading-2 text-black-normal m-0 leading-[1.2] whitespace-nowrap">03 Design Process</h2>} rightClassName="project-right-column pl-48 max-w-[1280px]">
                    <div className="project-right-block">
                    ...
                    <div className="w-full rounded-[4px] overflow-hidden">
                      <iframe title="TinyPaws Site Map" style={{ border: '0' }} width="100%" height="520" src={PROJECT_EMBED_URLS.tinypaws.siteMap} allowFullScreen/>
                    </div>
                </ProjectTwoColumnSection>
              </section>

              <section className="px-6 pb-16 mt-0">
                <ProjectTwoColumnSection rightClassName="project-right-column pl-48 max-w-[1280px] col-start-2">
                    <div className="project-right-block">
                      ...
                      <div className="grid grid-cols-[2.2fr_1fr_1fr_1fr] gap-6 items-end">
                        <img src={LogoBig} alt="TinyPaws primary logo" className="w-full h-auto object-contain col-span-1"/>
                        {[Logo1, Logo2, Logo3].map((src, idx) => (<img key={src} src={src} alt={`TinyPaws logo variation ${idx + 1}`} className="w-full h-auto object-contain"/>))}
                      </div>
                    </div>
            ...
            return (<div key={hex} className="w-full aspect-square rounded-[14px] flex items-center justify-center border border-black/5" style={{ backgroundColor: hex }}>
                            <span className="text-[14px] leading-none font-medium text-black-normal" style={useDefaultTextColor ? undefined : { color: 'var(--color-grey-normal)' }}>
                              {hex}
                            </span>
                          </div>);
        })}
                    ...
                    <div className="project-right-block mt-16">
                      ...
                      <div className="w-full rounded-[4px] overflow-hidden">
                        <iframe title="TinyPaws low fidelity wireframes" style={{ border: '0' }} width="100%" height="560" src={PROJECT_EMBED_URLS.tinypaws.lowFidelityWireframes} allowFullScreen/>
                      </div>
                    </div>
                    ...
                    <div className="project-right-block mt-16" data-lightbox-disabled="true">
                      ...
                      <div className="grid grid-cols-2 gap-8 items-start justify-items-center" style={{ perspective: '1800px' }}>
                        <button type="button" onMouseEnter={() => setActiveUsabilitySide('left')} onFocus={() => setActiveUsabilitySide('left')} onClick={() => setActiveUsabilitySide('left')} className="w-[66%] p-0 rounded-[4px] overflow-hidden bg-white cursor-pointer transition-all duration-500 ease-[cubic-bezier(0.2,0.8,0.2,1)]" style={{
            ...
            filter: activeUsabilitySide === 'left' ? 'none' : 'saturate(0.8) brightness(0.96)',
                          ...
                          <img src={UserTestBefore} alt="TinyPaws low-fidelity usability screen" className="w-full h-auto block object-cover"/>
                        </button>

                        <button type="button" onMouseEnter={() => setActiveUsabilitySide('right')} onFocus={() => setActiveUsabilitySide('right')} onClick={() => setActiveUsabilitySide('right')} className="w-[66%] p-0 rounded-[4px] overflow-hidden bg-white cursor-pointer transition-all duration-500 ease-[cubic-bezier(0.2,0.8,0.2,1)]" style={{
            ...
            filter: activeUsabilitySide === 'right' ? 'none' : 'saturate(0.8) brightness(0.96)',
                          ...
                          <img src={UserTestAfter} alt="TinyPaws refined usability screen" className="w-full h-auto block object-cover"/>
                        </button>
                      </div>
            ...
            : 'opacity-0 translate-y-2 pointer-events-none'}`}>
                    ...
                    <div className="grid gap-8 mt-2" data-lightbox-disabled="true">
                      <div className="grid grid-cols-2 gap-8 items-start justify-items-center" style={{ perspective: '1800px' }}>
                        <button type="button" onMouseEnter={() => setActiveUsabilitySideSecond('left')} onFocus={() => setActiveUsabilitySideSecond('left')} onClick={() => setActiveUsabilitySideSecond('left')} className="w-[66%] p-0 rounded-[4px] overflow-hidden bg-white cursor-pointer transition-all duration-500 ease-[cubic-bezier(0.2,0.8,0.2,1)]" style={{
            transformOrigin: 'left center',
            ...
            filter: activeUsabilitySideSecond === 'left' ? 'none' : 'saturate(0.8) brightness(0.96)',
                          ...
                          <img src={UserTestBeforeSecond} alt="TinyPaws low-fidelity volunteer page screen" className="w-full h-auto block object-cover"/>
                        </button>

                        <button type="button" onMouseEnter={() => setActiveUsabilitySideSecond('right')} onFocus={() => setActiveUsabilitySideSecond('right')} onClick={() => setActiveUsabilitySideSecond('right')} className="w-[66%] p-0 rounded-[4px] overflow-hidden bg-white cursor-pointer transition-all duration-500 ease-[cubic-bezier(0.2,0.8,0.2,1)]" style={{
            transformOrigin: 'right center',
            ...
            filter: activeUsabilitySideSecond === 'right' ? 'none' : 'saturate(0.8) brightness(0.96)',
                          ...
                          <img src={UserTestAfterSecond} alt="TinyPaws refined volunteer page screen" className="w-full h-auto block object-cover"/>
                        </button>
                      </div>
            ...
            : 'opacity-0 translate-y-2 pointer-events-none'}`}>
                    ...
                    <div className="project-right-block mt-16">
                      ...
                      <div className="w-full rounded-[4px] overflow-hidden">
                        <iframe title="TinyPaws high fidelity wireframes" style={{ border: '0' }} width="100%" height="560" src={PROJECT_EMBED_URLS.tinypaws.highFidelityWireframes} allowFullScreen/>
                      </div>
                    </div>
                </ProjectTwoColumnSection>
              </section>
              ...
              <section className="px-6 pb-16 mt-12">
                <ProjectTwoColumnSection left={<h2 className="type-heading-2 text-black-normal m-0 leading-[1.2] whitespace-nowrap">04 Promotional Material</h2>} rightClassName="project-right-column pl-48 max-w-[1280px]">
                    <div className="project-right-block">
              ...
              <section className="px-6 pb-16 mt-12">
                <ProjectTwoColumnSection left={<h2 className="type-heading-2 text-black-normal m-0 leading-[1.2] whitespace-nowrap">05 Final Results</h2>} rightClassName="project-right-column pl-48 max-w-[1280px]">
                    <div className="project-right-block">
                      <p className="type-heading-3 text-black-normal m-0 leading-[1.2]">Mockup</p>
                      <div className="flex flex-nowrap items-end gap-6">
                        <div className="flex-shrink-0" style={{ width: 'calc((100% - 1.5rem) * 1.3333 / 2.3333)' }}>
                          <img src={TinypawsMockup} alt="TinyPaws final mockup 1" className="w-full h-auto block object-contain"/>
                        </div>
                        <div className="flex-shrink-0" style={{ width: 'calc((100% - 1.5rem) / 2.3333)' }}>
                          <img src={TinypawsMockup2} alt="TinyPaws final mockup 2" className="w-full h-auto block object-contain"/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="project-right-block">
                      ...
                      <div className="w-full rounded-[4px] overflow-hidden">
                        <iframe title="TinyPaws prototype" style={{ border: '0' }} width="100%" height="560" src={PROJECT_EMBED_URLS.tinypaws.prototype} allowFullScreen/>
                      </div>
                    </div>
                </ProjectTwoColumnSection>
              </section>
                ...
                <Footer onNavigate={onNavigate} top={PROJECT_LAYOUT_METRICS.tinypaws.footerTop}/>
              </div>
            </div>
          </div>
        </div>
