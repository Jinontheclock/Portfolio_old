...
export default function ProjectMatchaLatte({ currentPage, language, onNavigate, onLanguageChange }: Props) {
    ...
    return (<div className="layout-viewport hide-scrollbar bg-grey-normal" style={{ "--layout-gutter": "0px" } as CSSProperties}>
      <div className="layout-canvas" style={{ "--layout-base-height": `${PROJECT_LAYOUT_METRICS.matchalatte.baseHeight}px` } as CSSProperties}>
        <div className="layout-canvas-inner">
          <div className="relative" style={{ minHeight: "var(--layout-base-height)" } as CSSProperties}>
            ...
            <div className="flex flex-col gap-0 mt-12">
              <ProjectHeader {...PROJECT_HEADER_CONTENT.matchalatte}/>

              <section className="px-6" data-lightbox-disabled="true">
                <div className="flex justify-center">
                  <img src={MatchaBanner} alt="Matcha Latte overview" className="w-full max-w-[1400px] h-auto"/>
                </div>
              </section>
            </div>
            ...
            <div>
                ...
                <ProjectTwoColumnSection left={<h2 className="type-heading-2 text-black-normal m-0 leading-[1.2] whitespace-nowrap">01 Design Process</h2>} rightClassName="project-right-column pl-48 max-w-[1280px]">
                    ...
                    <div className="project-sub-block mt-8">
                      ...
                      <div className="grid grid-cols-[260px_1fr] gap-10 items-start mt-1">
                        <div className="text-[12px] leading-[1.5] text-black-normal space-y-3">
                          {matchaTypographyRows.map((row) => (<div key={row.label} className="grid grid-cols-[140px_1fr] items-start gap-6">
                              <div>
                    ...
                    <div className="project-sub-block mt-12">
                      ...
                      <div className="grid gap-8 max-w-[980px] mt-1">
                        {matchaColorRows.map((row, index) => (<div key={row.label} className="grid grid-cols-[220px_1fr] gap-8 items-start">
                            <div className="grid gap-2">
                              <p className="m-0 text-[16px] font-normal leading-[1.3] text-black-normal">{row.label}</p>
                              <div className="relative h-[90px] rounded-[4px] overflow-hidden" style={{ backgroundColor: row.solid }}>
                            ...
                            <div className="grid gap-2">
                              {index === 0 ? (<p className="m-0 text-[16px] font-normal leading-[1.3] text-black-normal">background</p>) : (<div className="h-[21px]" aria-hidden="true"/>)}
                              <div className="relative h-[90px] rounded-[4px] overflow-hidden" style={{
                backgroundImage: `linear-gradient(90deg, ${row.gradientStart} 0%, ${MATCHA_GRADIENT_END} 100%)`,
                    ...
                    <div className="project-sub-block mt-12">
                      ...
                      <div className="grid grid-cols-[1.12fr_1fr] gap-8 max-w-[1120px] mt-2 items-start">
                        <img src={MatchaDieline1} alt="Matcha latte dieline label dimensions" className="w-full h-auto block"/>
                        <img src={MatchaDieline2} alt="Matcha latte can side and top dimensions" className="w-full h-auto block"/>
                      </div>
                    </div>
                    ...
                    <div className="project-sub-block mt-12">
                      ...
                      <div className="grid grid-cols-[0.73fr_1fr] gap-8 max-w-[1120px] mt-2 items-start">
                        <img src={MatchaComponents1} alt="Matcha latte brand components whisk motif and flavor circles" className="w-full h-auto block"/>
                        <img src={MatchaComponents2} alt="Matcha latte background texture components" className="w-full h-auto block"/>
                      </div>
                    </div>
                ...
                <ProjectTwoColumnSection left={<h2 className="type-heading-2 text-black-normal m-0 leading-[1.2] whitespace-nowrap">02 Final Result</h2>} rightClassName="project-right-column pl-48 max-w-[1280px]">
                    <div className="project-right-block">
                      ...
                      <div className="grid grid-cols-1 gap-0 max-w-[1180px]">
                        {MATCHA_LABEL_IMAGES.map((imageSrc, index) => (<img key={imageSrc} src={imageSrc} alt={`Matcha latte label design ${index + 1}`} className="w-full h-auto block first:mt-0 -mt-[2px]"/>))}
                      </div>
                    </div>
                    <div className="project-right-block">
                      ...
                      <div className="grid grid-cols-1 gap-6 max-w-[1180px]">
                        <div className="grid grid-cols-3 gap-6">
                          {MATCHA_MOCKUP_ROW_ONE_IMAGES.map((imageSrc, index) => (<div key={imageSrc} className="w-full aspect-[4/3] overflow-hidden">
                              <img src={imageSrc} alt={`Matcha latte mockup ${index + 1}`} className="w-full h-full object-cover block" style={index === 0 ? { objectPosition: '54% center' } : undefined}/>
                            </div>))}
                        </div>
                        <div className="w-full aspect-[16/10] overflow-hidden">
                          <img src={MatchaMockup4} alt="Matcha latte mockup 4" className="w-full h-full object-cover block" style={{ objectPosition: 'center 48%' }}/>
                        </div>
                      </div>
                    </div>
                </ProjectTwoColumnSection>
              ...
              <Footer onNavigate={onNavigate} top={PROJECT_LAYOUT_METRICS.matchalatte.footerTop}/>
            </div>
            </div>
          </div>
        </div>
